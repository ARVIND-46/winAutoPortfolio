      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="space-y-12 mb-24">
          <div className="space-y-4">
            <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-white tracking-tighter uppercase leading-tight md:leading-[0.8]">
              OUR <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-24 mb-32">
          <div className="space-y-4 group">
            <div className="text-7xl font-black text-blue-500 tracking-tighter transition-transform group-hover:scale-105 duration-500">
        ...
        <div className="relative group overflow-hidden">
           ...
           <div className="relative z-10 p-16 md:p-24 space-y-12">
              <blockquote className="text-3xl md:text-5xl font-bold text-white leading-[1.15] tracking-tight max-w-5xl">
