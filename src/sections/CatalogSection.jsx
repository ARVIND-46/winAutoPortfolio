  ...
  const catalogs = [
    {
      ...
      description: 'Access the complete Electronic Parts Catalog (EPC) for the entire Bajaj Two-Wheeler range. Genuine Bajaj bike spares available across Chennai.',
      image: twoWheelerImg,
    ...
    },
    {
      ...
      description: 'Detailed parts information and service manuals for all Bajaj Three-Wheeler commercial vehicles. Premium auto spares for all models.',
